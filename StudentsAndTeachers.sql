USE [master]
GO
/****** Object:  Database [StudentsAndTeachers]    Script Date: 6/23/2022 9:38:03 AM ******/
...
GO
/****** Object:  User [hui]    Script Date: 6/23/2022 9:38:04 AM ******/
CREATE USER [hui] FOR LOGIN [JSUser] WITH DEFAULT_SCHEMA=[db_owner]
GO
ALTER ROLE [db_owner] ADD MEMBER [hui]
GO
/****** Object:  Table [dbo].[Principals]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Projects]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Students]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Students-Teams]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Tasks]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Teachers]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Teams]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Teams-Projects]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Tasks]  WITH CHECK ADD  CONSTRAINT [FK_Tasks_Principals] FOREIGN KEY([principalId])
REFERENCES [dbo].[Principals] ([principalId])
GO
ALTER TABLE [dbo].[Tasks] CHECK CONSTRAINT [FK_Tasks_Principals]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[checkTaskId]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[checkTaskId]
...
schoolName=@schoolName AND taskId=@taskId

if @id=@taskId AND @schoolName=@schoolName
	Select 1 as [result]
else
	SELECT 0 as [result]
END
GO
/****** Object:  StoredProcedure [dbo].[insertStudent]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[insertTeacher]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[insertUser]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	SET NOCOUNT ON;
	INSERT INTO Users(username,firstName,lastName,password,address,phone,schoolName)
	VALUES(@Username,@FirstName,@LastName, CONVERT(varbinary(max),EncryptByPassPhrase('hui',@Password)   ,2),
	CONVERT(varbinary(max),EncryptByPassPhrase('hui',@Address)   ,2), @Phone,@SchoolName);

END
GO
/****** Object:  StoredProcedure [dbo].[returnPassword]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[returnStudentData]    Script Date: 6/23/2022 9:38:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
